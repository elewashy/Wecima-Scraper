...
def fetch_movies(page_number=1):
    url = f"https://wecima.video/category/%D8%A3%D9%81%D9%84%D8%A7%D9%85/?page_no={page_number}"
...
def get_arabic_movies(page_number=1):
    url = f"https://wecima.video/category/أفلام/افلام-عربي-arabic-movies/?page_no={page_number}"
    response = requests.get(url)
    soup = BeautifulSoup(response.content, "html.parser")
...
def get_english_movies(page_number=1):
    url = f"https://wecima.video/category/أفلام/10-movies-english-افلام-اجنبي/?page_no={page_number}"
    response = requests.get(url)
    soup = BeautifulSoup(response.content, "html.parser")
...
def get_indian_movies(page_number=1):
    url = f"https://wecima.video/category/أفلام/افلام-هندي-indian-movies/?page_no={page_number}"
    response = requests.get(url)
    soup = BeautifulSoup(response.content, "html.parser")
...
def get_turkish_movies(page_number=1):
    url = f"https://wecima.video/category/أفلام/1-افلام-تركى-turkish-films/?page_no={page_number}"
    response = requests.get(url)
    soup = BeautifulSoup(response.content, "html.parser")
...
def get_documentary_movies(page_number=1):
    url = f"https://wecima.video/category/أفلام/1-افلام-وثائقية-documentary-films/?page_no={page_number}"
    response = requests.get(url)
    soup = BeautifulSoup(response.content, "html.parser")
...
def get_full_pack_movies(page_number=1):
    url = f"https://wecima.video/category/أفلام/10-movies-english-افلام-اجنبي/1-سلاسل-الافلام-الكاملة-full-pack/?page_no={page_number}"
    response = requests.get(url)
    soup = BeautifulSoup(response.content, "html.parser")
